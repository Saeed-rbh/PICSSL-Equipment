...
export default function SampleRequestPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        alert("Sample Request Sent! We will contact you shortly with shipping instructions.");
    };
        ...
        <>
            ...
            <main className="container" style={{ paddingTop: '4rem', paddingBottom: '4rem', maxWidth: '600px' }}>
                ...
                <form onSubmit={handleSubmit} style={{ background: 'var(--bg-card)', padding: '2rem', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-color)' }}>
                    ...
                    <Input label="University / Institution" placeholder="e.g. York University" required />
                    <Input label="Supervisor Email" type="email" placeholder="supervisor@university.edu" required />
                    ...
                    <Input label="Sample Description" placeholder="Briefly describe composition" required />
                    <div style={{ marginBottom: '1rem' }}>
                    ...
                    <div style={{ marginBottom: '1rem' }}>
                        ...
                        <select style={{ width: '100%', padding: '0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', background: 'var(--bg-secondary)', color: 'var(--text-primary)', outline: 'none' }}>
